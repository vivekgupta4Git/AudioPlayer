...
class AudioPlayer @JvmOverloads constructor(
    ...
    private val endPositionText: TextView by lazy {
        findViewById(R.id.endPosText)
    }
    private val startPositionText: TextView by lazy {
        findViewById(R.id.startPosText)
    }
    private val audioFileImageView: ImageView by lazy {
